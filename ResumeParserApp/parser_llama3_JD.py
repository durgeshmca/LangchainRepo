...
#     return text
# create chat prompt 
system_prompt = '''You are an expert Recruter. Parse the resume given and respond  in json format only.Also normalize the parsed data.
Output:
{{
  "name": "<FULL_NAME>",
  "contact_information": {{
...
llm = ChatGroq(model="llama-3.2-1b-preview",disable_streaming=True)
